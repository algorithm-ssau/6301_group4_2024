        ...
        <div className='flex flex-col items-center justify-center min-w-96 mx-auto'>
			<div className='w-full p-6 rounded-lg shadow-md bg-gray-400 bg-clip-padding backdrop-filter backdrop-blur-lg bg-opacity-0'>
				<h1 className='text-3xl font-semibold text-center text-gray-300'>
					Регистрация в <span className='text-blue-500'> Мессенджере</span>
				</h1>

				<form onSubmit={handleSubmit}>
					<div>
						<label className='label p-2'>
							<span className='text-base label-text'>Имя и фамилия</span>
						</label>
						<input type='text' placeholder='Введите имя и фамилию' className='w-full input input-bordered  h-10'
					...
					<div>
						...
						<input type='password' placeholder='Введите пароль' className='w-full input input-bordered h-10' 
